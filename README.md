...
Archivo products.model.js se modificó para utilizar Firestore en lugar de un archivo JSON local. Este archivo contiene métodos para interactuar con la colección de productos en Firestore.
...
3) Presionar _send_ para listar los productos con GET.# api_figuras_collec
